  ...
  return (
    <div>
      <Paper sx={{ textAlign: "center" }}>
        <Typography sx={{fontFamily: "Courier Prime",fontSize: "2rem"}}>Greedy meter</Typography>
        <GaugeChart nrOfLevels={3}  percent={data.data[0].value/100} colors={["#FF5F6D", "#B8F1B0"]} textColor={"#000"} />
